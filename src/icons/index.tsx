...
export function ArrowDownArrowUpIcon({ width = 24, height = 24, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={width}
...
export function ArrowDownToBracketIcon({ width = 24, height = 24, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={width}
...
export function ArrowUpRightFromSquareIcon({ width = 24, height = 24, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={width}
...
export function BottleIcon({ width = 24, height = 24, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={width}
...
export function ChevronDownIcon({ width = 24, height = 24, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={width}
...
export function CircleAttentionIcon({ width = 24, height = 24, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={width}
...
export function CircleMinusIcon({ width = 24, height = 24, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={width}
...
export function CirclePlusIcon({ width = 24, height = 24, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={width}
...
export function CircleXmarkIcon({ width = 24, height = 24, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={width}
...
export function CopyIcon({ width = 24, height = 24, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={width}
...
export function DnaIcon({ width = 24, height = 24, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={width}
...
export function FileArrowDownIcon({ width = 24, height = 24, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={width}
...
export function InfoCircleIcon({ width = 20, height = 20, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 20 20"
      width={width}
...
export function MenuIcon({ width = 14, height = 10, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 14 10"
      width={width}
...
export function MinusIcon({ width = 24, height = 24, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={width}
      ...
      {...props}
    >
      <path d="M6 12L18 12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}

export function MoonStarsIcon({ width = 24, height = 24, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={width}
...
export function PlusIcon({ width = 24, height = 24, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={width}
...
export function SearchListIcon({ width = 24, height = 24, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={width}
...
export function SunMiniIcon({ width = 12, height = 12, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 12 12"
      width={width}
...
export function SunIcon({ width = 24, height = 24, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={width}
...
export function TestTubeIcon({ width = 24, height = 24, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={width}
...
export function ThermometerIcon({ width = 24, height = 24, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={width}
...
export function VirusIcon({ width = 24, height = 24, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={width}
...
export function XmarkLargeIcon({ width = 24, height = 24, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={width}
...
export function XmarkIcon({ width = 24, height = 24, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={width}
